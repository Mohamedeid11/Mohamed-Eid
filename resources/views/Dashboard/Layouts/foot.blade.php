...
<script src="{{asset('assets/js/demo/analytics.demo.js')}}"></script>
...
<script src="{{asset('assets/js/demo/chart-apex.demo.js')}}"></script>
...
<script src="{{asset('assets/js/demo/email-compose.demo.js')}}"></script>
...
<script src="{{asset('assets/plugins/kbw-countdown/dist/js/jquery.plugin.js')}}"></script>
<script src="{{asset('assets/plugins/kbw-countdown/dist/js/jquery.countdown.js')}}"></script>
<script src="{{asset('assets/js/demo/page-coming-soon.demo.js')}}"></script>
<script type="module" src="{{asset('assets/js/demo/page-gallery.demo.js')}}"></script>
<script src="{{asset('https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('assets/js/demo/product-details.demo.js')}}"></script>
<script src="{{asset('assets/js/demo/page-scrum-board.demo.js')}}"></script>
<script src="{{asset('assets/js/demo/pos-counter-checkout.demo.js')}}"></script>
<script src="{{asset('assets/js/demo/pos-customer-order.demo.js')}}"></script>
<script src="{{asset('assets/js/demo/pos-kitchen-order.demo.js')}}"></script>
<script src="{{asset('assets/js/demo/pos-menu-stock.demo.js')}}"></script>
<script src="{{asset('assets/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.js')}}"></script>
<script src="{{asset('assets/js/demo/pos-table-booking.demo.js')}}"></script>
...
<script src="{{asset('assets/js/demo/widgets.demo.js')}}"></script>
<!-- ================== END page-js ================== -->
